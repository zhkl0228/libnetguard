...
public class PacketUtil {
	 ...
	 * <a href="https://docs.oracle.com/javase/tutorial/java/nutsandbolts/datatypes.html">datatypes</a>
	 ...
	 */
	public static long getNetworkLong(byte[] buffer, int start, int length){
		long value = 0;
		int end = start + (length > 4 ? 4 : length);
