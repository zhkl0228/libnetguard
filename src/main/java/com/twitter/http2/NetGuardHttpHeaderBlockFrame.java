 ...
 */
public abstract class NetGuardHttpHeaderBlockFrame extends DefaultHttpStreamFrame
        implements HttpHeaderBlockFrame {

    private boolean invalid;
    private boolean truncated;
    private final HttpHeaders headers = new NetGuardHttp2Headers();
     ...
     */
    protected NetGuardHttpHeaderBlockFrame(int streamId) {
        super(streamId);
    }
