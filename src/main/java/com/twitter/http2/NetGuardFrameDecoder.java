 ...
 */
public class NetGuardFrameDecoder {
     ...
     */
    public NetGuardFrameDecoder(boolean server, HttpFrameDecoderDelegate delegate) {
     ...
     */
    public NetGuardFrameDecoder(boolean server, HttpFrameDecoderDelegate delegate, int maxChunkSize) {
        if (delegate == null) {
    ...
    public void decode(ByteBuf buffer) {
        if (state != State.READ_CONNECTION_HEADER &&
                state != State.READ_FRAME_HEADER) {
